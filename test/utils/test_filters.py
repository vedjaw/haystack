...
document_matches_filter_data = [
    ...
    pytest.param(
        {"field": "meta.date", "operator": ">=", "value": datetime(2024, 1, 1, tzinfo=timezone.utc)},
        Document(meta={"date": "2024-01-01T00:00:00+00:00"}),
        True,
        id=">= operator with aware datetime filter value and ISO 8601 string Document value",
    ),
    pytest.param(
        {"field": "meta.date", "operator": "<", "value": datetime(2025, 1, 1, tzinfo=timezone.utc)},
        Document(meta={"date": "2024-01-01"}),
        True,
        id="< operator with datetime filter value and ISO 8601 string Document value",
    ),
    pytest.param(
        {"field": "meta.date", "operator": "<=", "value": datetime(2024, 1, 1)},
        Document(meta={"date": "2024-01-01T00:00:00+00:00"}),
        True,
        id="<= operator with naive datetime filter value and aware ISO 8601 string Document value",
    ),
    pytest.param(
        {"field": "meta.page", "operator": ">", "value": 10},
        Document(),
